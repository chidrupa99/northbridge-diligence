...
flowchart TB
  ...
  subgraph ADAPT["3 · Swappable adapter — edgar_client.py"]
    ADP["fetch · parse · normalize · attach a SOURCE to every value<br/>compute ratios · judge meaningfulness · raise risk flags<br/>146 offline tests + golden-set regression pin this behaviour"]
  end
